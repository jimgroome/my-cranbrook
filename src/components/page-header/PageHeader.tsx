...
const PageHeader = async () => {
  ...
  return (
    <header
      className="fixed left-0 top-0 w-full z-9999 bg-white py-7 lg:py-0 transition-all ease-in-out duration-300"
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 lg:flex items-center justify-between relative">
        ...
        <div
          className="w-full lg:w-9/12 h-0 lg:h-auto invisible lg:visible lg:flex items-center justify-between"
        >
          <nav>
            <ul className="flex lg:items-center flex-col lg:flex-row gap-5 lg:gap-10">
              ...
              >
                <a
                  href="#"
                  className="hover:text-dark flex items-center justify-between gap-3"
                >
                  Home
                  <svg
                ...
                >
                  <li>
                    <a
                      href="index.html"
                      className="flex rounded-md text-sm hover:text-primary hover:bg-gray py-2 px-4"
                    >
                      Business Blog
                    </a>
                  </li>
          ...
          <div className="flex flex-wrap items-center gap-8.5 mt-7 lg:mt-0">
            ...
            <div className="flex items-center gap-4.5">
              ...
              <button
                className="rounded-md text-white font-medium flex py-2.5 px-5.5 bg-dark hover:opacity-90 lg:transition-all lg:ease-linear lg:duration-200"
              >
                Subscribe
              </button>
            </div>
